...
function HomeContent() {
  ...
  useEffect(() => {
    // Don't show homepage if any selection parameter is present
    if (pointId || poiId || cameraId) {
      ...
      <div className={styles.mainContainer}>
        ...
        <div className={styles.mapSectionContainer}>
          <MapSection
            ...
            autoSelectPOIId={poiId ? parseInt(poiId) : undefined}
            autoSelectFlockCameraId={cameraId ? parseInt(cameraId) : undefined}
          />
        </div>
      </div>
      {showHomePage && (
