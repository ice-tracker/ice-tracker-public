  ...
  return (
    <div className={`${styles.panelBase} ${styles.panelEvent}`}>
      ...
      <div className={styles.body}>
        <div>
          <span className={styles.headerLocation}>Report {eventIndex + 1}</span>
        </div>
        ...
        <div>
          ...
          <span className={styles.bodyDescription}>
            {currentEvent[eventIndex].Time || "Not provided"}
          </span>
        </div>
        ...
        <div>
          ...
          <br />
          <span className={styles.bodyDescription}>
            {currentEvent[eventIndex].Tactic || "Not provided"}
          </span>
        </div>
