      ...
      <div className={styles.body}>
        ...
        <div>
          <span className={styles.headerLocation}>
            {currentEvent[eventIndex].Location &&
             currentEvent[eventIndex].Location.toLowerCase() !== "(empty)"
        ...
        {/* Secure Location Badge */}
        {currentEvent[eventIndex].Sec && (
          <div className={styles.secureLocationBadge}>
            <Shield size={16} strokeWidth={2.5} className={styles.shieldIcon} />
            <span className={styles.secureLocationText}>
              Location Protected - Coordinates anonymized
            </span>
            <div className={styles.secureTooltip}>
              <Info size={14} className={styles.infoIcon} />
              <span className={styles.tooltipText}>
                This report is from a sensitive location (home/workplace). The
                address is hidden and map shows approximate location within a{" "}
                {currentEvent[eventIndex].Radius?.toFixed(2) || "0.50"}-mile
                radius for privacy.
              </span>
            </div>
          </div>
