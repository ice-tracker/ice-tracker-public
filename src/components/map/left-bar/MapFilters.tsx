...
interface MapFiltersProps {
  ...
  loading: boolean;
  activeListTab: "events" | "pois";
  setActiveListTab: (tab: "events" | "pois") => void;
}
              ...
              <div className={styles.tabContainerMobile}>
                <button
                  className={`${styles.tabButton} ${
                    activeListTab === "events" ? styles.tabButtonActive : ""
                  }`}
                ...
                <button
                  className={`${styles.tabButton} ${
                    activeListTab === "pois" ? styles.tabButtonActive : ""
                  }`}
