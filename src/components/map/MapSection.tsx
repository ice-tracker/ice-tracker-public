...
const MapSection: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const filtered = allPoints.filter((event) => {
      ...
      const eventDateObj = parseDMY(eventDate);
      const startDateObj = filterDateStart ? parseDMY(filterDateStart) : null;
      const endDateObj = filterDateEnd ? parseDMY(filterDateEnd) : null;
