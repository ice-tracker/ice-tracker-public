...
export default function SightingFormComponent() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (
      ...
      setErrorMessage("Cars must be whole numbers (integers).");
      displayMessage("Cars must be whole numbers (integers).", true);
      return;
    }
  ...
  return (
    <div className={styles.formContainer}>
      ...
      >
      <div className={`${styles.header} ${styles.title}`}>Report Sighting </div>
