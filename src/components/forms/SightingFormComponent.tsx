...
export default function SightingFormComponent() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (
      !Number.isInteger(formData.Agents) ||
      !Number.isInteger(formData.Cars)
    ) {
      setErrorMessage("Agents and Cars must be whole numbers (integers).");
      displayMessage("Agents and Cars must be whole numbers (integers).", true);
      return;
    }
